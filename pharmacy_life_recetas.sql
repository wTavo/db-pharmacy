...
CREATE TABLE `recetas` (
  ...
  `cedula_medico` varchar(20) DEFAULT NULL,
  `medicamento` varchar(100) NOT NULL,
  `unidad_de_medida` varchar(50) DEFAULT NULL,
  `dosis` decimal(10,2) DEFAULT NULL,
  `frecuencia` varchar(100) DEFAULT NULL,
  `via_de_administracion` varchar(100) DEFAULT NULL,
  `fecha_inicio` date DEFAULT NULL,
  `fecha_fin` date DEFAULT NULL,
  `indicaciones_adicionales` text,
  PRIMARY KEY (`id_receta`),
  KEY `id_medico` (`id_medico`),
  CONSTRAINT `recetas_ibfk_1` FOREIGN KEY (`id_medico`) REFERENCES `usuarios` (`id_usuario`)
